...
class _CornerPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawLine(Offset(size.width - 20, 0), Offset(size.width, 0),
        paint); // Top right corner
    canvas.drawLine(Offset(size.width, 0), Offset(size.width, 20), paint);

    canvas.drawLine(Offset(0, size.height - 20), Offset(0, size.height),
    ...
    canvas.drawLine(Offset(size.width - 20, size.height),
        Offset(size.width, size.height), paint); // Bottom right corner
